...
| Plan                                                                                                  | Status                                | Owns                                                                                                 |
| ----------------------------------------------------------------------------------------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| [Microsoft Store release](./microsoft-store-release-plan.md)                                          | 0.6.2 live; 0.7.0 in certification   | Windows launch identity, packaging, signing, validation, listing, certification, and operations      |
...
| [Per-bridge Sync Box](./per-bridge-sync-box-plan.md)                                                  | Shipped in 0.7.0 (several per bridge) | Multiple Sync Boxes and bridge association                                                           |
